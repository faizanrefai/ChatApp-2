...
**/
//static void	xmpp_xmlStartElement(void *ctx, const xmlChar  *nodeName, const xmlChar  *nodePrefix, const xmlChar  *nodeUri, int   nb_namespaces, const xmlChar **namespaces, int   nb_attributes, int   nb_defaulted, const xmlChar **attributes) {
//	int i, j;
...
**/
//static void xmpp_xmlEndElement(void *ctx, const xmlChar *localname, const xmlChar *prefix, const xmlChar *URI) {
//	xmlParserCtxt *ctxt = (xmlParserCtxt *)ctx;
//	
//	// Update our parent node pointer
//	if (ctxt->node != NULL)
