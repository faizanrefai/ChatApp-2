...
**/ 
- (void)insertOccupantWithPresence:(XMPPPresence *)presence room:(XMPPRoom *)room stream:(XMPPStream *)xmppStream {
	// Extract needed information
...
**/
- (void)updateOccupant:(XMPPRoomOccupantCoreDataStorageObject *)occupant withPresence:(XMPPPresence *)presence room:(XMPPRoom *)room stream:(XMPPStream *)stream {
	// Extract needed information
 ...
 * Optional override hook.
**/
- (void)removeOccupant:(XMPPRoomOccupantCoreDataStorageObject *)occupant withPresence:(XMPPPresence *)presence room:(XMPPRoom *)room stream:(XMPPStream *)stream {
...
- (XMPPRoomOccupantCoreDataStorageObject *)occupantForJID:(XMPPJID *)jid stream:(XMPPStream *)xmppStream inContext:(NSManagedObjectContext *)moc {
