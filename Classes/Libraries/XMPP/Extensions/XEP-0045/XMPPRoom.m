...
- (void)fetchConfigurationForm {
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		[responseTracker addID:fetchID target:self selector:@selector(handleConfigurationFormResponse:withInfo:) timeout:60.0];
...
- (void)fetchBanList {
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		[responseTracker addID:fetchID target:self selector:@selector(handleFetchBanListResponse:withInfo:) timeout:60.0];
	}};
...
- (void)fetchMembersList {
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		[responseTracker addID:fetchID target:self selector:@selector(handleFetchMembersListResponse:withInfo:) timeout:60.0];
	}};
...
- (void)fetchModeratorsList {
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		[responseTracker addID:fetchID target:self selector:@selector(handleFetchModeratorsListResponse:withInfo:) timeout:60.0];
...
- (NSString *)editRoomPrivileges:(NSArray *)items {
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		[responseTracker addID:iqID target:self selector:@selector(handleEditRoomPrivilegesResponse:withInfo:) timeout:60.0];
...
- (void)destoryRoom {
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		[responseTracker addID:iqID target:self selector:@selector(handleDestroyRoomResponse:withInfo:) timeout:60.0];
