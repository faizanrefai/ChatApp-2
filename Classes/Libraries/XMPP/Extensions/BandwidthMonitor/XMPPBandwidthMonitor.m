...
- (void)updateBandwidth {
	...
	XMPPLogVerbose(@"Bandwidth = Out(%.0f, %.0f) In(%.0f, %.0f)", currentOutgoingBandwidth, smoothedAverageOutgoingBandwidth, currentIncomingBandwidth, smoothedAverageIncomingBandwidth);
}
