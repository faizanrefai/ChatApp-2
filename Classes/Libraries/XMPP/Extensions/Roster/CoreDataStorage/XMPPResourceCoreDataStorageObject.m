...
+ (id)insertInManagedObjectContext:(NSManagedObjectContext *)moc withPresence:(XMPPPresence *)presence streamBareJidStr:(NSString *)streamBareJidStr {
	...
	newResource = [NSEntityDescription insertNewObjectForEntityForName:@"XMPPResourceCoreDataStorageObject" inManagedObjectContext:moc];
